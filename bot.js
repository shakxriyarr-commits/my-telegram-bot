...
let courierStats = {}; // Kuryerlar hisoboti uchun
...
bot.action(/c_done_(.+)/, async (ctx) => {
    ...
    if (order) {
        // Kuryer statistikasini oshirish
...
// --- MENYU VA BOSHQA STANDART FUNKSIYALAR (O'ZGARMAGAN) ---
bot.hears('🍴 Menyu', (ctx) => {
